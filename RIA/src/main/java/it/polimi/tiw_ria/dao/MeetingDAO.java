...
public class MeetingDAO {
    ...
    public List<Meeting> findMeetingsNotExpiredByUser(int idCreator) throws SQLException {
        ...
        String query = "SELECT * FROM tiw.meeting WHERE idCreator = ? AND date >= CURDATE()";//" and time > current_time";
    ...
    public List<Meeting> findMeetingById(int idUser) throws SQLException {
        ...
        String query = "SELECT M.idMeeting, title, date, time, length, numberOfParticipants, idCreator FROM tiw.meeting as M, tiw.participants as P WHERE P.idParticipant = ? AND M.idMeeting = P.idMetting AND date >= CURDATE()";//" and time > current_time";
